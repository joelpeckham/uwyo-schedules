...
/**
 * Inert week grid matching live calendar geometry (weekdays by default).
...
export function WeekCalendarGridSkeleton() {
  ...
  return (
    <div
      ...
      style={{ minWidth: `max(100%, ${PLANNER_WEEKDAY_GRID_MIN_WIDTH_REM}rem)` }}
      aria-hidden
    >
      <div
      ...
      >
        ...
        {PLANNER_WEEKDAY_DAY_INDICES.map((dayIndex) => (
          <div
            key={dayIndex}
        ...
        >
          ...
          <div className="flex min-w-0 flex-1">
            {PLANNER_WEEKDAY_DAY_INDICES.map((dayIndex) => (
              <div
                key={dayIndex}
                className="relative min-w-[4.5rem] flex-1 border-l border-border bg-muted/[0.07]"
